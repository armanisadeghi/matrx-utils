...
def _discover_entry_points(
    ...
    For every external file that imports from `subdirectory`:
      1. Collect directly-imported names  (from matrx_ai.tools import handle_tool_calls_v2)
    ...
    # This filters out submodule-name imports (e.g. `from matrx_ai import tools`).
