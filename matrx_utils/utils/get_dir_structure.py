...
if __name__ == "__main__":
    ...
    config = {
        "root_directory": r"/Users/armanisadeghi/code/matrx-frontend/docs/db_rebuild",
        "project_root": r"/Users/armanisadeghi/code/matrx-frontend/docs/db_rebuild",
        "ignore_directories": [
            ".",
            "_dev",
            ".history",
    ...
    directory_structure, output_file, text_output_file = generate_and_save_directory_structure(
        config
    )
