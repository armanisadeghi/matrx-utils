...
if __name__ == "__main__":
    ...
    #
    PROJECT_ROOT: Path = Path("/Users/armanisadeghi/code/aidream/packages/matrx-ai")
    SUBDIRECTORIES: list[str] = ["matrx_ai"]
    ...
    #
    FORCE_REFRESH_CHILDREN: bool = True
    ...
    SIGNATURES_EXCLUDE: list[str] | None = ["tests", "db", "local_data", "docs"]  # e.g. ["tests", "migrations", "conftest.py"]
