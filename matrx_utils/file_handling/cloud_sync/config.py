...
class CloudSyncConfig:
    ...
    def resolve_supabase_key(self) -> str:
        """Return the Supabase secret key (new-format sb_secret_...).

        Legacy JWT SUPABASE_SERVICE_ROLE_KEY / SUPABASE_MATRIX_KEY are NOT
        consulted. See https://supabase.com/docs/guides/getting-started/api-keys.
        """
