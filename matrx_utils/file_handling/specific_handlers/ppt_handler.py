...
class PPTHandler(FileHandler):
    ...
    def read_ppt_file(self, path) -> None | Presentation:
        try:
    ...
    def write_ppt_file(self, path, content: Presentation):
    ...
    # Custom Methods
    def custom_read_ppt(self, path) -> Presentation | None:
    ...
    # Core Methods
    def read_ppt(self, root, path) -> Presentation | None:
