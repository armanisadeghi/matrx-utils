...
class Transaction:
    ...
    async def begin(self):
        ...
        try:
            ...
            raise TransactionError(model=None, operation="begin", original_error=e)
    ...
    async def commit(self):
        ...
        try:
            ...
            raise TransactionError(model=None, operation="commit", original_error=e)
    ...
    async def rollback(self):
        ...
        try:
            ...
            raise TransactionError(model=None, operation="rollback", original_error=e)
...
class TransactionManager:
    def __init__(self):
        try:
            ...
            raise ConfigurationError(model=None, config_key="transaction_manager", reason=str(e))
    ...
    async def transaction(self):
        ...
        try:
            ...
            if transaction and transaction.is_active:
                await transaction.rollback()
            raise TransactionError(model=None, operation="transaction", original_error=e)
    ...
    async def run_in_transaction(self, func: Callable[..., Any], *args, **kwargs) -> Any:
        ...
        async with self.transaction() as transaction:
            try:
                ...
                raise TransactionError(model=None, operation="run_in_transaction", original_error=e)
    ...
    async def savepoint(self, name: str):
        ...
        try:
            ...
            raise TransactionError(model=None, operation=f"create_savepoint:{name}", original_error=e)
    ...
    async def rollback_to_savepoint(self, name: str):
        ...
        try:
            ...
            raise TransactionError(model=None, operation=f"rollback_to_savepoint:{name}", original_error=e)
    ...
    async def release_savepoint(self, name: str):
        ...
        try:
            ...
            raise TransactionError(model=None, operation=f"release_savepoint:{name}", original_error=e)
