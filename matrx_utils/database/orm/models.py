...
from matrx_utils.database.orm.core.fields import (CharField, EnumField, DateField, TextField, IntegerField, FloatField,
                                      BooleanField, DateTimeField, UUIDField, JSONField, DecimalField, BigIntegerField,
                                      SmallIntegerField, JSONBField, UUIDArrayField, JSONBArrayField, ForeignKey)
...
class Recipe(Model):
    ...
    _inverse_foreign_keys = {
        'compiled_recipes': {'from_model': 'CompiledRecipe', 'from_field': 'recipe_id', 'referenced_field': 'id',
                             'related_name': 'compiled_recipes'},
        'ai_agents': {'from_model': 'AiAgent', 'from_field': 'recipe_id', 'referenced_field': 'id',
                      'related_name': 'ai_agents'},
        'recipe_displays': {'from_model': 'RecipeDisplay', 'from_field': 'recipe', 'referenced_field': 'id',
                            'related_name': 'recipe_displays'},
        'recipe_processors': {'from_model': 'RecipeProcessor', 'from_field': 'recipe', 'referenced_field': 'id',
                              'related_name': 'recipe_processors'},
        'recipe_models': {'from_model': 'RecipeModel', 'from_field': 'recipe', 'referenced_field': 'id',
                          'related_name': 'recipe_models'},
        'recipe_brokers': {'from_model': 'RecipeBroker', 'from_field': 'recipe', 'referenced_field': 'id',
                           'related_name': 'recipe_brokers'},
        'recipe_messages': {'from_model': 'RecipeMessage', 'from_field': 'recipe_id', 'referenced_field': 'id',
                            'related_name': 'recipe_messages'},
        'recipe_tools': {'from_model': 'RecipeTool', 'from_field': 'recipe', 'referenced_field': 'id',
                         'related_name': 'recipe_tools'},
        'recipe_functions': {'from_model': 'RecipeFunction', 'from_field': 'recipe', 'referenced_field': 'id',
...
class ScrapeDomain(Model):
    ...
    _inverse_foreign_keys = {
        'scrape_path_patterns': {'from_model': 'ScrapePathPattern', 'from_field': 'scrape_domain_id',
                                 'referenced_field': 'id', 'related_name': 'scrape_path_patterns'},
        'scrape_jobs': {'from_model': 'ScrapeJob', 'from_field': 'scrape_domain_id', 'referenced_field': 'id',
                        'related_name': 'scrape_jobs'},
        'scrape_domain_quick_scrape_settingss': {'from_model': 'ScrapeDomainQuickScrapeSettings',
                                                 'from_field': 'scrape_domain_id', 'referenced_field': 'id',
                                                 'related_name': 'scrape_domain_quick_scrape_settingss'},
        'scrape_domain_disallowed_notess': {'from_model': 'ScrapeDomainDisallowedNotes',
                                            'from_field': 'scrape_domain_id', 'referenced_field': 'id',
                                            'related_name': 'scrape_domain_disallowed_notess'},
        'scrape_domain_robots_txts': {'from_model': 'ScrapeDomainRobotsTxt', 'from_field': 'scrape_domain_id',
                                      'referenced_field': 'id', 'related_name': 'scrape_domain_robots_txts'},
        'scrape_domain_notess': {'from_model': 'ScrapeDomainNotes', 'from_field': 'scrape_domain_id',
                                 'referenced_field': 'id', 'related_name': 'scrape_domain_notess'},
        'scrape_domain_sitemaps': {'from_model': 'ScrapeDomainSitemap', 'from_field': 'scrape_domain_id',
                                   'referenced_field': 'id', 'related_name': 'scrape_domain_sitemaps'},
        'scrape_tasks': {'from_model': 'ScrapeTask', 'from_field': 'scrape_domain_id', 'referenced_field': 'id',
                         'related_name': 'scrape_tasks'},
        'scrape_quick_failure_logs': {'from_model': 'ScrapeQuickFailureLog', 'from_field': 'scrape_domain_id',
                                      'referenced_field': 'id', 'related_name': 'scrape_quick_failure_logs'}}
...
class ScrapeJob(Model):
    ...
    _inverse_foreign_keys = {
        'scrape_cycle_trackers': {'from_model': 'ScrapeCycleTracker', 'from_field': 'scrape_job_id',
                                  'referenced_field': 'id', 'related_name': 'scrape_cycle_trackers'},
        'scrape_tasks': {'from_model': 'ScrapeTask', 'from_field': 'scrape_job_id', 'referenced_field': 'id',
                         'related_name': 'scrape_tasks'}}
...
class AiProvider(Model):
    ...
    _inverse_foreign_keys = {
        'ai_settingss': {'from_model': 'AiSettings', 'from_field': 'ai_provider', 'referenced_field': 'id',
                         'related_name': 'ai_settingss'},
        'ai_models': {'from_model': 'AiModel', 'from_field': 'model_provider', 'referenced_field': 'id',
...
class DataInputComponent(Model):
    ...
    _inverse_foreign_keys = {
        'message_brokers': {'from_model': 'MessageBroker', 'from_field': 'default_component', 'referenced_field': 'id',
                            'related_name': 'message_brokers'},
        'brokers': {'from_model': 'Broker', 'from_field': 'custom_source_component', 'referenced_field': 'id',
                    'related_name': 'brokers'},
        'data_brokers': {'from_model': 'DataBroker', 'from_field': 'input_component', 'referenced_field': 'id',
...
class ScrapeCachePolicy(Model):
    ...
    is_public = BooleanField(default=False)
    authenticated_read = BooleanField(default=False)
    _inverse_foreign_keys = {'scrape_path_pattern_cache_policys': {'from_model': 'ScrapePathPatternCachePolicy',
                                                                   'from_field': 'scrape_cache_policy_id',
                                                                   'referenced_field': 'id',
                                                                   'related_name': 'scrape_path_pattern_cache_policys'}}
...
class ScrapePathPattern(Model):
    ...
    authenticated_read = BooleanField(default=True)
    _inverse_foreign_keys = {
        'scrape_configurations': {'from_model': 'ScrapeConfiguration', 'from_field': 'scrape_path_pattern_id',
                                  'referenced_field': 'id', 'related_name': 'scrape_configurations'},
        'scrape_path_pattern_overrides': {'from_model': 'ScrapePathPatternOverride',
                                          'from_field': 'scrape_path_pattern_id', 'referenced_field': 'id',
                                          'related_name': 'scrape_path_pattern_overrides'},
        'scrape_path_pattern_cache_policys': {'from_model': 'ScrapePathPatternCachePolicy',
                                              'from_field': 'scrape_path_pattern_id', 'referenced_field': 'id',
                                              'related_name': 'scrape_path_pattern_cache_policys'}}
...
class ScrapePathPatternCachePolicy(Model):
    ...
    is_public = BooleanField(default=False)
    authenticated_read = BooleanField(default=False)
    _inverse_foreign_keys = {'scrape_cycle_trackers': {'from_model': 'ScrapeCycleTracker',
                                                       'from_field': 'scrape_path_pattern_cache_policy_id',
                                                       'referenced_field': 'id',
                                                       'related_name': 'scrape_cycle_trackers'},
                             'scrape_parsed_pages': {'from_model': 'ScrapeParsedPage',
                                                     'from_field': 'scrape_path_pattern_cache_policy_id',
                                                     'referenced_field': 'id', 'related_name': 'scrape_parsed_pages'}}
...
class AiModel(Model):
    ...
    _inverse_foreign_keys = {
        'ai_model_endpoints': {'from_model': 'AiModelEndpoint', 'from_field': 'ai_model_id', 'referenced_field': 'id',
                               'related_name': 'ai_model_endpoints'},
        'ai_settingss': {'from_model': 'AiSettings', 'from_field': 'ai_model', 'referenced_field': 'id',
                         'related_name': 'ai_settingss'},
        'recipe_models': {'from_model': 'RecipeModel', 'from_field': 'ai_model', 'referenced_field': 'id',
                          'related_name': 'recipe_models'}}
...
class Broker(Model):
    ...
    _inverse_foreign_keys = {
        'recipe_brokers': {'from_model': 'RecipeBroker', 'from_field': 'broker', 'referenced_field': 'id',
                           'related_name': 'recipe_brokers'},
        'registered_functions': {'from_model': 'RegisteredFunction', 'from_field': 'return_broker',
                                 'referenced_field': 'id', 'related_name': 'registered_functions'},
        'automation_boundary_brokers': {'from_model': 'AutomationBoundaryBroker', 'from_field': 'broker',
                                        'referenced_field': 'id', 'related_name': 'automation_boundary_brokers'}}
...
class DataOutputComponent(Model):
    ...
    additional_params = JSONBField()
    _inverse_foreign_keys = {
        'data_brokers': {'from_model': 'DataBroker', 'from_field': 'output_component', 'referenced_field': 'id',
                         'related_name': 'data_brokers'}}
...
class FlashcardData(Model):
    ...
    updated_at = DateTimeField()
    _inverse_foreign_keys = {
        'flashcard_historys': {'from_model': 'FlashcardHistory', 'from_field': 'flashcard_id', 'referenced_field': 'id',
                               'related_name': 'flashcard_historys'},
        'flashcard_set_relationss': {'from_model': 'FlashcardSetRelations', 'from_field': 'flashcard_id',
                                     'referenced_field': 'id', 'related_name': 'flashcard_set_relationss'},
        'flashcard_imagess': {'from_model': 'FlashcardImages', 'from_field': 'flashcard_id', 'referenced_field': 'id',
...
class Organizations(Model):
    ...
    _inverse_foreign_keys = {'permissionss': {'from_model': 'Permissions', 'from_field': 'granted_to_organization_id',
                                              'referenced_field': 'id', 'related_name': 'permissionss'},
                             'organization_memberss': {'from_model': 'OrganizationMembers',
                                                       'from_field': 'organization_id', 'referenced_field': 'id',
                                                       'related_name': 'organization_memberss'},
                             'organization_invitationss': {'from_model': 'OrganizationInvitations',
                                                           'from_field': 'organization_id', 'referenced_field': 'id',
                                                           'related_name': 'organization_invitationss'}}
...
class Projects(Model):
    ...
    created_by = ForeignKey(to_model=Users, to_column='id', )
    _inverse_foreign_keys = {
        'project_memberss': {'from_model': 'ProjectMembers', 'from_field': 'project_id', 'referenced_field': 'id',
                             'related_name': 'project_memberss'},
        'taskss': {'from_model': 'Tasks', 'from_field': 'project_id', 'referenced_field': 'id',
                   'related_name': 'taskss'}}
...
class ScrapeCycleTracker(Model):
    ...
    authenticated_read = BooleanField(default=False)
    _inverse_foreign_keys = {
        'scrape_cycle_runs': {'from_model': 'ScrapeCycleRun', 'from_field': 'scrape_cycle_tracker_id',
                              'referenced_field': 'id', 'related_name': 'scrape_cycle_runs'},
        'scrape_parsed_pages': {'from_model': 'ScrapeParsedPage', 'from_field': 'scrape_cycle_tracker_id',
                                'referenced_field': 'id', 'related_name': 'scrape_parsed_pages'}}
...
class Tasks(Model):
    ...
    created_by = ForeignKey(to_model=Users, to_column='id', )
    _inverse_foreign_keys = {
        'task_assignmentss': {'from_model': 'TaskAssignments', 'from_field': 'task_id', 'referenced_field': 'id',
                              'related_name': 'task_assignmentss'},
        'task_attachmentss': {'from_model': 'TaskAttachments', 'from_field': 'task_id', 'referenced_field': 'id',
                              'related_name': 'task_attachmentss'},
        'task_commentss': {'from_model': 'TaskComments', 'from_field': 'task_id', 'referenced_field': 'id',
...
class AiEndpoint(Model):
    ...
    params = JSONField()
    _inverse_foreign_keys = {'ai_model_endpoints': {'from_model': 'AiModelEndpoint', 'from_field': 'ai_endpoint_id',
                                                    'referenced_field': 'id', 'related_name': 'ai_model_endpoints'},
                             'ai_settingss': {'from_model': 'AiSettings', 'from_field': 'ai_endpoint',
                                              'referenced_field': 'id', 'related_name': 'ai_settingss'}}
...
class AutomationMatrix(Model):
    ...
    _inverse_foreign_keys = {'actions': {'from_model': 'Action', 'from_field': 'matrix', 'referenced_field': 'id',
                                         'related_name': 'actions'},
                             'automation_boundary_brokers': {'from_model': 'AutomationBoundaryBroker',
                                                             'from_field': 'matrix', 'referenced_field': 'id',
...
class DataBroker(Model):
    ...
    _inverse_foreign_keys = {
        'broker_values': {'from_model': 'BrokerValue', 'from_field': 'data_broker', 'referenced_field': 'id',
                          'related_name': 'broker_values'},
        'message_brokers': {'from_model': 'MessageBroker', 'from_field': 'broker_id', 'referenced_field': 'id',
                            'related_name': 'message_brokers'}}
...
class MessageTemplate(Model):
    ...
    content = TextField()
    _inverse_foreign_keys = {
        'message_brokers': {'from_model': 'MessageBroker', 'from_field': 'message_id', 'referenced_field': 'id',
                            'related_name': 'message_brokers'},
        'recipe_messages': {'from_model': 'RecipeMessage', 'from_field': 'message_id', 'referenced_field': 'id',
                            'related_name': 'recipe_messages'}}
...
class RegisteredFunction(Model):
    ...
    _inverse_foreign_keys = {
        'system_functions': {'from_model': 'SystemFunction', 'from_field': 'rf_id', 'referenced_field': 'id',
                             'related_name': 'system_functions'},
        'args': {'from_model': 'Arg', 'from_field': 'registered_function', 'referenced_field': 'id',
                 'related_name': 'args'}}
...
class ScrapeCycleRun(Model):
    ...
    authenticated_read = BooleanField(default=False)
    _inverse_foreign_keys = {
        'scrape_tasks': {'from_model': 'ScrapeTask', 'from_field': 'scrape_cycle_run_id', 'referenced_field': 'id',
                         'related_name': 'scrape_tasks'},
        'scrape_parsed_pages': {'from_model': 'ScrapeParsedPage', 'from_field': 'scrape_cycle_run_id',
                                'referenced_field': 'id', 'related_name': 'scrape_parsed_pages'}}
...
class ScrapeOverride(Model):
    ...
    authenticated_read = BooleanField(default=True)
    _inverse_foreign_keys = {
        'scrape_override_values': {'from_model': 'ScrapeOverrideValue', 'from_field': 'scrape_override_id',
                                   'referenced_field': 'id', 'related_name': 'scrape_override_values'},
        'scrape_path_pattern_overrides': {'from_model': 'ScrapePathPatternOverride', 'from_field': 'scrape_override_id',
                                          'referenced_field': 'id', 'related_name': 'scrape_path_pattern_overrides'}}
...
class ScrapeTask(Model):
    ...
    authenticated_read = BooleanField(default=False)
    _inverse_foreign_keys = {
        'scrape_task_responses': {'from_model': 'ScrapeTaskResponse', 'from_field': 'scrape_task_id',
                                  'referenced_field': 'id', 'related_name': 'scrape_task_responses'},
        'scrape_parsed_pages': {'from_model': 'ScrapeParsedPage', 'from_field': 'scrape_task_id',
                                'referenced_field': 'id', 'related_name': 'scrape_parsed_pages'}}
...
class SystemFunction(Model):
    ...
    _inverse_foreign_keys = {'tools': {'from_model': 'Tool', 'from_field': 'system_function', 'referenced_field': 'id',
                                       'related_name': 'tools'},
                             'recipe_functions': {'from_model': 'RecipeFunction', 'from_field': 'function',
...
class AiSettings(Model):
    ...
    _inverse_foreign_keys = {
        'ai_agents': {'from_model': 'AiAgent', 'from_field': 'ai_settings_id', 'referenced_field': 'id',
                      'related_name': 'ai_agents'}}
...
class AudioLabel(Model):
    ...
    description = TextField()
    _inverse_foreign_keys = {
        'audio_recordings': {'from_model': 'AudioRecording', 'from_field': 'label', 'referenced_field': 'id',
...
class Category(Model):
    ...
    created_at = DateTimeField(null=False)
    _inverse_foreign_keys = {
        'subcategorys': {'from_model': 'Subcategory', 'from_field': 'category_id', 'referenced_field': 'id',
...
class CompiledRecipe(Model):
    ...
    authenticated_read = BooleanField(null=False, default=False)
    _inverse_foreign_keys = {
        'applets': {'from_model': 'Applet', 'from_field': 'compiled_recipe_id', 'referenced_field': 'id',
                    'related_name': 'applets'}}
...
class Conversation(Model):
    ...
    keywords = JSONBField()
    _inverse_foreign_keys = {
        'messages': {'from_model': 'Message', 'from_field': 'conversation_id', 'referenced_field': 'id',
...
class DisplayOption(Model):
    ...
    additional_params = JSONBField()
    _inverse_foreign_keys = {
        'recipe_displays': {'from_model': 'RecipeDisplay', 'from_field': 'display', 'referenced_field': 'id',
                            'related_name': 'recipe_displays'}}
...
class FlashcardSets(Model):
    ...
    _inverse_foreign_keys = {'flashcard_set_relationss': {'from_model': 'FlashcardSetRelations', 'from_field': 'set_id',
...
class Processor(Model):
    ...
    params = JSONBField()
    _inverse_foreign_keys = {
        'recipe_processors': {'from_model': 'RecipeProcessor', 'from_field': 'processor', 'referenced_field': 'id',
                              'related_name': 'recipe_processors'}}
...
class ScrapeConfiguration(Model):
    ...
    authenticated_read = BooleanField(default=True)
    _inverse_foreign_keys = {
        'scrape_parsed_pages': {'from_model': 'ScrapeParsedPage', 'from_field': 'scrape_configuration_id',
                                'referenced_field': 'id', 'related_name': 'scrape_parsed_pages'}}
...
class ScrapePathPatternOverride(Model):
    ...
    _inverse_foreign_keys = {
        'scrape_parsed_pages': {'from_model': 'ScrapeParsedPage', 'from_field': 'scrape_path_pattern_override_id',
                                'referenced_field': 'id', 'related_name': 'scrape_parsed_pages'}}
...
class ScrapeTaskResponse(Model):
    ...
    authenticated_read = BooleanField(default=False)
    _inverse_foreign_keys = {
        'scrape_parsed_pages': {'from_model': 'ScrapeParsedPage', 'from_field': 'scrape_task_response_id',
                                'referenced_field': 'id', 'related_name': 'scrape_parsed_pages'}}
...
class Subcategory(Model):
    ...
    created_at = DateTimeField(null=False)
    _inverse_foreign_keys = {
        'applets': {'from_model': 'Applet', 'from_field': 'subcategory_id', 'referenced_field': 'id',
                    'related_name': 'applets'}}
...
class Tool(Model):
    ...
    additional_params = JSONBField()
    _inverse_foreign_keys = {
        'recipe_tools': {'from_model': 'RecipeTool', 'from_field': 'tool', 'referenced_field': 'id',
                         'related_name': 'recipe_tools'}}
...
class Transformer(Model):
    ...
    _inverse_foreign_keys = {'actions': {'from_model': 'Action', 'from_field': 'transformer', 'referenced_field': 'id',
                                         'related_name': 'actions'}}
...
class WcClaim(Model):
    ...
    _inverse_foreign_keys = {
        'wc_reports': {'from_model': 'WcReport', 'from_field': 'claim_id', 'referenced_field': 'id',
                       'related_name': 'wc_reports'}}
...
class WcImpairmentDefinition(Model):
    ...
    _inverse_foreign_keys = {
        'wc_injurys': {'from_model': 'WcInjury', 'from_field': 'impairment_definition_id', 'referenced_field': 'id',
...
class WcReport(Model):
    ...
    _inverse_foreign_keys = {
        'wc_injurys': {'from_model': 'WcInjury', 'from_field': 'report_id', 'referenced_field': 'id',
                       'related_name': 'wc_injurys'}}
