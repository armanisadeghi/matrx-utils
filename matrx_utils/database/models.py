...
#     _inverse_foreign_keys = {
#         "scrape_path_patterns": {
#             "from_model": "ScrapePathPattern",
#             "from_field": "scrape_domain_id",
#             "referenced_field": "id",
#             "related_name": "scrape_path_patterns",
#         },
#         "scrape_domain_quick_scrape_settingss": {
#             "from_model": "ScrapeDomainQuickScrapeSettings",
#             "from_field": "scrape_domain_id",
#             "referenced_field": "id",
#             "related_name": "scrape_domain_quick_scrape_settingss",
#         },
#         "scrape_domain_disallowed_notess": {
#             "from_model": "ScrapeDomainDisallowedNotes",
#             "from_field": "scrape_domain_id",
#             "referenced_field": "id",
#             "related_name": "scrape_domain_disallowed_notess",
#         },
#         "scrape_domain_robots_txts": {
#             "from_model": "ScrapeDomainRobotsTxt",
#             "from_field": "scrape_domain_id",
#             "referenced_field": "id",
#             "related_name": "scrape_domain_robots_txts",
#         },
#         "scrape_domain_notess": {
#             "from_model": "ScrapeDomainNotes",
#             "from_field": "scrape_domain_id",
#             "referenced_field": "id",
#             "related_name": "scrape_domain_notess",
#         },
#         "scrape_domain_sitemaps": {
#             "from_model": "ScrapeDomainSitemap",
#             "from_field": "scrape_domain_id",
#             "referenced_field": "id",
#             "related_name": "scrape_domain_sitemaps",
#         },
#     }
...
#         "brokers": {
#             "from_model": "Broker",
#             "from_field": "custom_source_component",
#             "referenced_field": "id",
...
#     _inverse_foreign_keys = {
#         "permissionss": {
#             "from_model": "Permissions",
#             "from_field": "granted_to_organization_id",
#             "referenced_field": "id",
#             "related_name": "permissionss",
#         },
#         "organization_memberss": {
#             "from_model": "OrganizationMembers",
#             "from_field": "organization_id",
#             "referenced_field": "id",
#             "related_name": "organization_memberss",
#         },
#         "organization_invitationss": {
#             "from_model": "OrganizationInvitations",
#             "from_field": "organization_id",
#             "referenced_field": "id",
...
#         "args": {
#             "from_model": "Arg",
#             "from_field": "registered_function",
#             "referenced_field": "id",
#             "related_name": "args",
#         },
#     }
...
#     authenticated_read = BooleanField(default="true")
#     _inverse_foreign_keys = {
#         "scrape_override_values": {
#             "from_model": "ScrapeOverrideValue",
#             "from_field": "scrape_override_id",
#             "referenced_field": "id",
#             "related_name": "scrape_override_values",
#         },
#         "scrape_path_pattern_overrides": {
#             "from_model": "ScrapePathPatternOverride",
#             "from_field": "scrape_override_id",
#             "referenced_field": "id",
...
#     id = UUIDField(primary_key=True, null=False)
#     scrape_domain_id = ForeignKey(
#         to_model=ScrapeDomain,
#         to_column="id",
#     )
...
#             "from_model": "ScrapeConfiguration",
#             "from_field": "scrape_path_pattern_id",
#             "referenced_field": "id",
#             "related_name": "scrape_configurations",
#         },
#         "scrape_path_pattern_overrides": {
#             "from_model": "ScrapePathPatternOverride",
#             "from_field": "scrape_path_pattern_id",
...
#     id = UUIDField(primary_key=True, null=False)
#     ai_endpoint = ForeignKey(
#         to_model=AiEndpoint,
#         to_column="id",
#         default="4bedf336-b274-4cdb-8202-59fd282ae6a0",
#     )
#     ai_provider = ForeignKey(
#         to_model=AiProvider,
#         to_column="id",
#         default="99fa34b1-4c36-427f-ab73-cc56f1d5c4a0",
#     )
