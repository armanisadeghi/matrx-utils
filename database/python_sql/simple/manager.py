...
if __name__ == '__main__':
    ...
    vcprint(schema_manager.get_foreign_keys('flashcard_history'), title='Foreign Keys for Flashcard History', pretty=True, color='cyan')

    # Example: Get references to a specific table
    vcprint(schema_manager.get_references('flashcard_sets'), title='Tables Referencing Flashcard Sets', pretty=True, color='yellow')
