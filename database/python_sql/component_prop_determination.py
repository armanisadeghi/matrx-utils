import os
from database.python_sql.db_objects import extract_unique_values_and_counts, get_db_objects
...
def determine_component_details(database_results_object, fields_to_extract):
    ...
    vcprint(data=database_results_object, title='Database Objects', pretty=True, verbose=False, color='blue')
    ...
    vcprint(data=unique_values_and_counts_specific, title='Unique Values and Counts for Selected Fields', pretty=True, verbose=True, color='green')
    ...
    vcprint(data=unique_values_and_counts_all, title='Unique Values and Counts for All Fields', pretty=True, verbose=False, color='blue')
    ...
    vcprint(data=mapped_components, title='Mapped Components', pretty=True, verbose=False, color='magenta')





fields_to_extract = ['full_type', 'base_type', 'is_array', 'nullable', 'default', 'is_primary_key', 'character_maximum_length', 'enum_labels']
