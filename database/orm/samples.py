from database.orm.supabase.core.fields import CharField, IntegerField, DateTimeField, EmailField, JSONField
...
# Bulk operations
new_users = create.bulk_create(User, [
