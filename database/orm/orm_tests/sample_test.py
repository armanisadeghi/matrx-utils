from database.orm.core.extended import BaseManager
from common import vcprint
from database.models import CompiledRecipeManager, DataBrokerManager
import asyncio
...
async def compiled_recipe_manager_test(compiled_recipe_id):
    ...
    vcprint(compiled_recipe, "Compiled Recipe Data", verbose=True, pretty=True, color="bright_lavender")
