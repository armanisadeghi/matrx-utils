...
from common import vcprint, cool_print
from database.models import DataBroker, MessageBroker
...
def final_message():
    ...
    type_sentence("\n")
    type_sentence("But I hope you appreciate the REALLY REALLY UNIQUE features, such as the inverse foreign key relationships, and the ability to 'reach through' a relationship to get other related objects.\n")
    type_sentence("\n")
    type_sentence("And I think the caching is really cool as well and allows you to have full caching, without thinking about it. But we have to be very careful about using it and properly set cache policies.\n")
    type_sentence("\n")
    last_message()

def last_message():
    print("\n")
    cool_print("=============== =============== =============== ===============  ===============", color="bright_purple", style="bold")
    time.sleep(0.08)
    cool_print("=============== =============== =============== ===============  ===============", color="bright_purple", style="bold")
    time.sleep(0.08)
    cool_print("=============== ===============                 ===============  ===============", color="bright_purple", style="bold")
    time.sleep(0.08)
    cool_print("=============== ===============   Matrx Nexus   ===============  ===============", color="bright_purple", style="bold")
    time.sleep(0.08)
    cool_print("=============== ===============       ORM       ===============  ===============", color="bright_purple", style="bold")
    time.sleep(0.08)
    cool_print("=============== =============== =============== ===============  =======@=======", color="bright_purple", style="bold")
    time.sleep(0.08)
    cool_print("=============== =============== =============== ===============  ===============", color="bright_purple", style="bold")
...
async def test_bulk_operations():
    ...
    for broker in brokers:
        ...
        if hasattr(broker, '_default_component_cache'):
            ...
            vcprint(f"- Default component: {component.id if component else None}", color="blue")
...
async def test_complex_query():
    ...
    brokers = await DataBroker.filter(
        data_type='str'
    ).order_by(
        'name'
    ).all()
