...
class DataBroker(Model):
    ...
    default_component = ForeignKey(is_native=True, to_model='DataInputComponent', to_field='id', default='6463aae0-9480-4c4c-90b8-e3ce9c11a103')
...
class MessageBroker(Model):
    ...
    default_component_override = ForeignKey(to_model='DataInputComponent', )
