...
from database.orm.core.relations import ForeignKey, ForeignKeyReference, InverseForeignKeyReference
...
def inspect_relationship_lookup():
    ...
    test_fields = ['default_component', 'data_input_component_reference', 'message_brokers_inverse']
