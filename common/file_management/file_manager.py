...
from common.file_management.file_handler import FileHandler
from common.file_management.specific_handlers.html import HtmlHandler
from common.file_management.specific_handlers.json import JsonHandler
from common.file_management.specific_handlers.markdown import MarkdownHandler
from common.file_management.specific_handlers.text import TextHandler
from common.file_management.specific_handlers.image import ImageHandler
from common.file_management.batch_handler import BatchHandler
...
class FileManager:
    _instances = {}
    _log_intro = "[MATRIX FILE MANAGER]"
